...
describe("<TextualBody />", () => {
    ...
    describe("renders plain-text m.text correctly", () => {
        ...
        it("linkification get applied correctly into the DOM", () => {
            const ev = mkEvent({
                ...
                user: "sender",
                content: {
                    body: "Visit https://facemeeting.com/",
                    msgtype: "m.text",
                },
                event: true,
            });
            ...
            expect(content.html()).toBe('<span class="mx_EventTile_body" dir="auto">' +
                'Visit <a href="https://facemeeting.com/" class="linkified" target="_blank" rel="noreferrer noopener">' +
                'https://facemeeting.com/</a></span>');
        });
    });
    ...
    describe("renders formatted m.text correctly", () => {
        ...
        it("pills get injected correctly into the DOM", () => {
            const ev = mkEvent({
                ...
                content: {
                    ...
                    msgtype: "m.text",
                    format: "org.matrix.custom.html",
                    formatted_body: "Hey <a href=\"https://link.facemeeting.com/#/@user:server\">Member</a>",
                },
                event: true,
            });
        ...
        it("pills do not appear for event permalinks", () => {
            const ev = mkEvent({
                ...
                content: {
                    body:
                        "An [event link](https://link.facemeeting.com/#/!ZxbRYPQXDXKGmDnJNg:example.com/" +
                        "$16085560162aNpaH:example.com?via=example.com) with text",
                    msgtype: "m.text",
                    format: "org.matrix.custom.html",
                    formatted_body:
                        "An <a href=\"https://link.facemeeting.com/#/!ZxbRYPQXDXKGmDnJNg:example.com/" +
        ...
        it("pills appear for room links with vias", () => {
            const ev = mkEvent({
                ...
                content: {
                    body:
                        "A [room link](https://link.facemeeting.com/#/!ZxbRYPQXDXKGmDnJNg:example.com" +
                        "?via=example.com&via=bob.com) with vias",
                    msgtype: "m.text",
                    format: "org.matrix.custom.html",
                    formatted_body:
                        "A <a href=\"https://link.facemeeting.com/#/!ZxbRYPQXDXKGmDnJNg:example.com" +
    ...
    it("renders url previews correctly", () => {
        ...
        expect(widgets.at(0).prop("links")).toEqual(["https://facemeeting.com/"]);
        ...
        wrapper.setProps({
            ...
            wrapper.setState({}, () => {
                ...
                // at this point we should have exactly two links (not the facemeeting.com one anymore)
