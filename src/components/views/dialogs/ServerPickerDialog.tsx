...
export default class ServerPickerDialog extends React.PureComponent<IProps, IState> {
    ...
    // If for some reason someone enters "facemeeting.com" for a URL, we could do a lookup to
    // find their homeserver without demanding they use "https://facemeeting.com"
    ...
    public render() {
        let text;
        if (this.defaultServer.hsName === "facemeeting.com") {
            text = _t("Facemeeting.com is the biggest public homeserver in the world, so it’s a good place for many.");
        }
        ...
        >
            <form className="mx_Dialog_content" id="mx_ServerPickerDialog" onSubmit={this.onSubmit}>
                ...
                <p>
                    { _t("Use your preferred FM homeserver if you have one, or host your own.") }
                </p>
                ...
                <h4>{ _t("Learn more") }</h4>
                <a href="https://facemeeting.com/faq/#what-is-a-homeserver%3F" target="_blank" rel="noreferrer noopener">
