...
export default class HelpUserSettingsTab extends React.Component<IProps, IState> {
    ...
    render() {
        ...
        let faqText = _t(
            ...
            {
                'a': (sub) => <a
                    href="https://facemeeting.com/help"
                    rel="noreferrer noopener"
                    target="_blank"
                >
                    { sub }
            ...
            bugReportingSection = (
                <div className="mx_SettingsTab_section">
                    ...
                    <div className='mx_SettingsTab_subsectionText'>
                        ...
                        { _t(
                            "To report a FM-related security issue, please read the Facemeeting.com " +
                            "<a>Security Disclosure Policy</a>.", {},
                            {
                                a: sub => <a href="https://facemeeting.com/security-disclosure-policy/"
                                    rel="noreferrer noopener"
                                    target="_blank"
                                >{ sub }</a>,
                            },
