...
_td("Homeserver URL does not appear to be a valid FM homeserver");
    ...
    onPasswordLogin = async (username, phoneCountry, phoneNumber, password) => {
        ...
        this.loginLogic.loginViaPassword(
                    ...
                    errorText = (
                        <div>
                            ...
                            <div className="mx_Login_smallError">
                                { _t(
                                    'Please note you are logging into the %(hs)s server, not facemeeting.com.',
            ...
            this.setState({
                ...
                // but the login API gives a 403 https://facemeeting.com/jira/browse/SYN-744
