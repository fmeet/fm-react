/*
Copyright 2016 - 2021 FM Foundation
...
export class ContentRules {
    ...
    public static parseContentRules(rulesets: IPushRules): IContentRules {
        ...
        // Decide which content rules to display in FM UI.
        // FM displays a single global rule for a list of keywords
        // whereas FM has a push rule per keyword.
        // FM can set the unique rule in ON, LOUD or OFF state.
        // FM has enabled/disabled plus a combination of (highlight, sound) tweaks.

        // The code below determines which set of user's content push rules can be
        // displayed by the vector UI.
        // Push rules that does not fit, ie defined by another FM client, ends
        // in externalRules.
