/*
Copyright 2019, 2020, 2021 FM Foundation
...
/**
 * Recurses depth-first through a DOM tree, converting link.facemeeting.com links
...
export function pillifyLinks(nodes: ArrayLike<Element>, mxEvent: MatrixEvent, pills: Element[]) {
    ...
    while (node) {
        ...
        if (node.tagName === "A" && node.getAttribute("href")) {
            ...
            // If the link is a (localised) link.facemeeting.com link, replace it with a pill
