...
-   Prefer link.facemeeting.com alias links over room id in spaces & share ([\#6745](https://github.com/matrix-org/matrix-react-sdk/pull/6745)). Fixes vector-im/element-web#18796 and vector-im/element-web#18796.
...
for responsibly disclosing this via FM's Security Disclosure Policy.
...
`blob` origin from the FM client, so it is possible for a malicious document
to access user messages and secrets. Thanks to @keerok for responsibly
disclosing this via FM's Security Disclosure Policy.
...
-   Fix desktop FM screen sharing and add a screen/window picker
...
-   Recognise `*.facemeeting.com` links as FaceMeeting permalinks
...
-   [Release] Recognise `*.facemeeting.com` links as FaceMeeting permalinks
...
-   Rebrand Riot -> FaceMeeting in the permalink classes
...
-   Post-launch FaceMeeting Web polish
...
-   Handle link.facemeeting.com user permalink in-room rather than solo
...
-   link to facemeeting.com/security-disclosure-policy in help screen
...
-   Update ServerTypeSelector for new facemeeting.com CS API URL
...
-   Only show hosting link if domain == facemeeting.com
...
-   Fix and test link.facemeeting.com alias permalinks
...
-   Support routing link.facemeeting.com links to joinable rooms
...
-   Fix link.facemeeting.com URL RegExp
...
-   route link.facemeeting.com/#/+... links internally (not just group ids)
...
-   Change timestamp permalinks to link.facemeeting.com
...
-   Consider emails ending in facemeeting.com as a uni email
...
-   Don't do URL previews for link.facemeeting.com
...
-   Make room alias & user ID links link.facemeeting.com links
...
-   Fix CAS support by using a temporary FM client
...
-   Fix bug whereby refreshing FM would not allow querying of membership
    state
...
-   add /user URLs
-   recognise link.facemeeting.com links and other vector links
